...
class ApplicationSecurityPropertiesTest {
  ...
  //  @Test
  //  void shouldBuildJwt() {
  //    ApplicationSecurityProperties.Authentication.Jwt jwt = new ApplicationSecurityProperties.Authentication.Jwt();
  //    jwt.setSecret("secret");
  //    jwt.setBase64Secret("secret");
  //    jwt.setTokenValidityInSeconds(1000);
  //    jwt.setTokenValidityInSeconds(1000);
  //    jwt.setTokenValidityInSecondsForRememberMe(1000);
  //
  //    assertThat(jwt.getSecret())
  //  }
